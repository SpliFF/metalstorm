...
| `core/impostor-atlas.ts` | The single source of truth for the sprite-atlas convention (8 yaw × 3 pitch × N frames, cell index, cell→UV). Shared by the feature LOD and the unit/squad impostor path. Pure + unit-tested. |
