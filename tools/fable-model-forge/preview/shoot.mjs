// shoot.mjs — headless screenshots of the preview page.
// usage: node preview/shoot.mjs [modelPath] [outPrefix]
import { chromium } from 'playwright';
import { mkdirSync } from 'fs';

const model = process.argv[2] || '/out/fable_tank_png.gltf';
const prefix = process.argv[3] || 'tank';
const base = 'http://127.0.0.1:8899/preview/index.html';

const SHOTS = [
  { name: 'front34', q: 'az=210&el=16&dist=15' },
  { name: 'rear34', q: 'az=40&el=20&dist=15' },
  { name: 'side', q: 'az=270&el=8&dist=15' },
  { name: 'front', q: 'az=180&el=10&dist=14' },
  { name: 'top', q: 'az=200&el=62&dist=16' },
  { name: 'aim', q: 'az=225&el=14&dist=15&yaw=55&pitch=-10' },
  { name: 'close', q: 'az=235&el=12&dist=8' },
];
