  ...
  4. IMPOSTOR RULE — the four infantry impostor defs satisfy the impostor
     lane's numeric rules at the new scale:
       ...
       - framing constant: (model bbox-centre Y − impostor_centre_y) /
         impostor_size stays at the measured -0.0096 ± 0.01 (2026-08-20 rebake calibration) — _builder.lua's
         "one framing constant, not four" (scale-invariant: every term is a
         length, PLAN-metalstorm-impostors M11 fire 2);
       - quad sanity: impostor_size / model height within [1.05, 1.20] (the
         band the four rebaked 2026-08-20 sheets are framed at).
...
SWAP_MAX_PX = 20.0
SWAP_MIN_PX = 4.0
# Re-measured 2026-08-27 against the 2026-08-20 texture-enrichment rebake
# calibration (the current baker fits tighter than the 2026-08 sheets, so the
# framing constant and quad band both moved): four units cluster at
# -0.0093..-0.0098 framing and 1.084..1.128 size/height.
FRAMING_CONST = -0.0096
FRAMING_TOL = 0.01
QUAD_RATIO_BAND = (1.05, 1.20)
