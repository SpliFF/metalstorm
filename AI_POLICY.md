...
The Recoil project has strict rules for AI usage:
...
These rules apply only to outside contributions to Recoil. Maintainers
...
Please remember that Recoil is maintained by humans.
