...
CMD.MOVE_STATE = 50; CMD.SETBASE = 55; CMD.SELFD = 65
CMD.SET_WANTED_MAX_SPEED = 70; CMD.LOAD_UNITS = 75
CMD.LOAD_ONTO = 76
CMD.UNLOAD_UNITS = 80; CMD.UNLOAD_UNIT = 81
CMD.ONOFF = 85; CMD.RECLAIM = 90; CMD.CLOAK = 95
CMD.STOCKPILE = 100; CMD.MANUALFIRE = 105; CMD.RESTORE = 110
CMD.REPEAT = 115; CMD.TRAJECTORY = 120; CMD.RESURRECT = 125
CMD.CAPTURE = 130; CMD.AUTOREPAIRLEVEL = 135; CMD.IDLEMODE = 145
