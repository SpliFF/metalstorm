 ...
 *  seeded `teams`. A PlayerRoster broadcast before GameStart carries no ally
 *  teams (the sim hasn't assigned them), so a player's allyTeam starts as a
 *  best-effort copy of its team id; this corrects it. Faithful to Recoil,
 *  where a player's allyTeam
