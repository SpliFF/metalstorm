...
constructor(
  ...
  public payload: AuthResponseT|ChatReceiveT|EntityCreateT|EntityDestroyT|GameEventBatchT|GameInfoT|PongT|ReconnectResponseT|ResourceUpdateT|ServerErrorT|null = null
){}
