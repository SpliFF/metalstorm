...
public:
	...
	/// PLAN-maps.md §2j option C. A feature whose def DECLARES a deck (at any
	/// height, 0 included) is SEATED: it holds its staged y instead of being
	/// clamped up to the ground,
