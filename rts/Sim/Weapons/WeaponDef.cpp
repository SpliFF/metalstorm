	...
	, collisionFlags(0)
{
	...
	// ColorMap loading removed — rendering is client-side
...
// Server-side stubs: weapon model loading is handled by the asset pipeline.
S3DModel* WeaponDef::LoadModel()       { return visuals.model; }
S3DModel* WeaponDef::LoadModel() const { return visuals.model; }
