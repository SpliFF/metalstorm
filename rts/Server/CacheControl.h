...
//
// Build stamp: unique per build (git hash + timestamp from CMake).
// Append ?v=<stamp> to asset URLs for automatic cache-busting on
// new deployments. Immutable caching means browsers keep assets
// forever and only re-fetch when the stamp changes.
//
...
/// Generated by CMake from git hash + timestamp.
